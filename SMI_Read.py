...
#MetadataLen = Metadata Length
    ...
    mStr=mNVME.shell_cmd("nvme read %s -s 0 -z 512 -y %s 2>&1"%(mNVME.dev,MetadataLen))
...
def testDW10_DW11(SLBA, msg0, msg1 , ExpectCommandSuccess):  
    ...
    mStr=mNVME.shell_cmd("nvme io-passthru %s -o 0x2 -n 1 -l 16 -r --cdw10=%s --cdw11=%s 2>&1"%(mNVME.dev, cdw10, cdw11))
...
def testDW12(LR, FUA, PRINFO, NLB, ExpectCommandSuccess):      
    ...
    mStr=mNVME.shell_cmd("nvme io-passthru %s -o 0x2 -n 1 -l 16 -r --cdw10=%s --cdw11=%s --cdw12=%s 2>&1"%(mNVME.dev, cdw10, cdw11, cdw12))
    retCommandSueess=bool(re.search("NVMe command result:00000000", mStr))
    if (retCommandSueess ==  ExpectCommandSuccess) :        
        return True         
    else:
...
def testDW13(DSM, ExpectCommandSuccess):      
    mStr=mNVME.shell_cmd("nvme io-passthru %s -o 0x2 -n 1 -l 16 -r --cdw13=%s 2>&1"%(mNVME.dev, DSM))
    retCommandSueess=bool(re.search("NVMe command result:00000000", mStr))
    if (retCommandSueess ==  ExpectCommandSuccess) :
        return True         
    else:
...
def testDW14(EILBRT, ExpectCommandSuccess):      
    mStr=mNVME.shell_cmd("nvme io-passthru %s -o 0x2 -n 1 -l 16 -r --cdw14=%s 2>&1"%(mNVME.dev, EILBRT))
    retCommandSueess=bool(re.search("NVMe command result:00000000", mStr))
    if (retCommandSueess ==  ExpectCommandSuccess) :
        return True         
    else:
...
def testDW15(ELBATM,ELBAT, ExpectCommandSuccess):      
    ...
    mStr=mNVME.shell_cmd("nvme io-passthru %s -o 0x2 -n 1 -l 16 -r --cdw15=%s 2>&1"%(mNVME.dev, CDW15))
    retCommandSueess=bool(re.search("NVMe command result:00000000", mStr))
    if (retCommandSueess ==  ExpectCommandSuccess) :
        return True         
    else:
