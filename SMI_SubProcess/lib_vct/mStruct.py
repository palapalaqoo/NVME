...
# ref to webpage,  http://code.activestate.com/recipes/498149-a-higher-level-struct-module/
import struct
...
name_to_code = {
    ...
    'Char'             : 'c',   # 1 byte
    'Byte'             : 'b',   # 1 byte
    'UnsignedByte'     : 'B',   # 1 byte
    'Int'              : 'i',       # 4 byte
    'UnsignedInt'      : 'I',   # 4 byte
    'Short'            : 'h',   # 2 byte
    'UnsignedShort'    : 'H',   # 2 byte
    'Long'             : 'l',   # 4 byte
    'UnsignedLong'     : 'L',   # 4 byte
    'String'           : 's',  
    'PascalString'     : 'p',  
    'Pointer'          : 'P',
    'Float'            : 'f',
...
class MetaStruct(type):
    def __init__(cls, name, bases, d):
        ...
        cls.StructSize=cls._struct_size
