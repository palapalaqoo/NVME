...
class IdCtrl_(object, NVMECom):
    ...
    TNVMCAP=RegDescriptor("id-ctrl", "tnvmcap",0 , 65535, RegType.decimal)
    UNVMCAP=RegDescriptor("id-ctrl", "unvmcap",0 , 65535, RegType.decimal)
    ...
    MNTMT=RegDescriptor("id-ctrl", "mntmt",0 , 65535, RegType.decimal)
    MXTMT=RegDescriptor("id-ctrl", "mxtmt",0 , 65535, RegType.decimal)
